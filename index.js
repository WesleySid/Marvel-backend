...
app.get("/comics", async (req, res) => {
  try {
    ...
    const response = await axios.get(
      `https://lereacteur-marvel-api.herokuapp.com/comics?apiKey=FHmiZnYEhOqgaFA8&skip=${skip}`
    );
...
app.get("/comic/:id", async (req, res) => {
  try {
    ...
    console.log(id);
    const response = await axios.get(
      `https://lereacteur-marvel-api.herokuapp.com/comic/${id}?apiKey=FHmiZnYEhOqgaFA8`
    );
